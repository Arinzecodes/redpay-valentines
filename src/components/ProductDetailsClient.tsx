...
import { productSizes, showToast } from "@/utils";
...
const ProductDetailsClient = ({ item }: ProductDetailsClientProps) => {
        ...
        <section className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-redpay-blue font-century cursor-pointer hover:underline">
                Size Guide
              </span>
            </div>
