        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-[600px] rounded-2xl shadow-2xl p-8 animate-zoom">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-century font-bold text-redpay-dark">Personal Details</h2>
                    <p className="text-redpay-grey text-sm mt-1">Please enter your details to complete the purchase.</p>
                </div>

                {/* Form */}
                <div className="flex flex-col gap-4">
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-redpay-grey pl-4">Full Name</label>
                        <input 
                            name="name" 
                            value={formData.name} 
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-redpay-grey pl-4">Email Address</label>
                        <input 
                            name="email" 
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-redpay-grey pl-4">Phone Number</label>
                        <input 
                            name="phone" 
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-redpay-grey pl-4">Shipping Address</label>
                        <input 
                            name="address" 
                ...
                <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-400">
                    ...
                    <span>Secured by <span className="font-bold text-redpay-red">REDPAY</span></span>
                </div>
            </div>
        </div>
    );
