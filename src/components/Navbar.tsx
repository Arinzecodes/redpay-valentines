        ...
        <nav className="w-full bg-redpay-cream/80 backdrop-blur-md border-b border-redpay-red/10">
          <div className="max-w-[1240px] mx-auto px-4 xl:px-0 h-[80px] flex items-center justify-between relative">
            ...
            >
              {RedpayImage ? (
                ...
                <div className="text-center">
                  <div className="bg-redpay-red text-white text-xs px-2 py-1 rounded-t-sm">
                    REDPAY
                  </div>
                  <div className="text-redpay-red font-century text-lg tracking-widest">
                    STORE
                  </div>
                </div>
              )}
            ...
            <div className="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
              <button
                onClick={goHome}
                className="border-b-2 border-redpay-red pb-1 text-redpay-red font-century"
              >
                Shop
              </button>
              <button
